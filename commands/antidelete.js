...
const OWNER_NUMBER = "919242963129@s.whatsapp.net";
...
From: @${senderName}`,
                ...
                if (mediaType === 'image') {
                    await sock.sendMessage(OWNER_NUMBER, { image: { url: mediaPath }, ...mediaOptions });
                } else if (mediaType === 'video') {
                    await sock.sendMessage(OWNER_NUMBER, { video: { url: mediaPath }, ...mediaOptions });
                }
...
async function handleMessageRevocation(sock, revocationMessage) {
    try {
        ...
        if (deletedBy.includes(sock.user.id) || deletedBy === OWNER_NUMBER) return;
