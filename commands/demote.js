...
async function demoteCommand(sock, chatId, mentionedJids, message) {
    try {
        ...
        const demotionMessage = `*『 𝙐𝙉 𝘼𝘿𝙈𝙄𝙉.... 🫵 👤⬇️』* 

👤 *𝙈𝙖𝙞𝙣 𝙐𝙨𝙚𝙧${userToDemote.length > 1 ? '𝙨' : ''}:*
${usernames.map(name => `• ${name}`).join('\n')}

👑 * 𝘿𝙄𝙎𝘾𝙍𝙄𝘽𝙀 𝙐𝙎𝙀𝙍:* @${message.key.participant ? message.key.participant.split('@')[0] : message.key.remoteJid.split('@')[0]}

> *_ব্যাপার টা হলো 𝘾𝙃𝙀𝘼𝙍 টা একটু ভারী হয়ে গেছিলো....💨🤯_*
